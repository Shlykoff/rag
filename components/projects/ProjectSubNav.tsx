...
// usePathname()-based active-tab highlighting -- the server can't know
// which child route is currently active. The actual pathname -> active-tab
// derivation is a pure function (lib/ui/project-nav.ts's
// resolveActiveProjectTab), unit-tested there without needing to render

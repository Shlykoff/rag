    ...
    <div className="sources-page">
      <header className="sources-page-header">
        ...
        <p className="field-hint">
          Сохраните API-ключи провайдеров, которыми хотите пользоваться. Модель чата и модель эмбеддингов
          (поиск по документам) выбираются в каждом проекте отдельно из моделей провайдеров с сохранённым
          ключом. Ключи хранятся в зашифрованном виде и никогда не показываются повторно после сохранения —
          если нужно проверить или заменить ключ, придётся ввести его заново.
        </p>
      </header>
      <ProfileForm />
    </div>
